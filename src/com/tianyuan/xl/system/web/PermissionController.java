...
import com.tianyuan.xl.system.service.PermissionService;
...
public class PermissionController extends BaseController{
	...
	@ResponseBody
	public Map<String, Object> menuOperationDate(String pid){
	...
	@ResponseBody
	public String create(@PathVariable("pname") String pname,@PathVariable("pid") String pid){
	...
	public String updateMenuForm(@PathVariable("id") String id, Model model) {
		model.addAttribute("permission", permissionService.get(id));
		model.addAttribute("action", "update");
		return "system/menuForm";
	}
