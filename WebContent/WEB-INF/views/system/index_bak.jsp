			...
			<div id="topbar" class="top-bar">
				<div class="top-bar-left">
					<h1 style="margin-left: 10px; margin-top: 10px; color: #fff">
						XLR3基础平台<span style="color: #3F4752"></span>
					</h1>
				</div>
			...
			<div id="toolbar"
				...
				<div id="buttonbar">
					...
					<div id="layout_north_set">
						...
						<div id="btnUpdatePwd" data-options="iconCls:'pwd'">修改密码</div>
							...
							<div id="pp" style="position: relative">
								<div data-options="region: 'north'" style="width: 48%;">
									<div id="pgrid" title="test" collapsible="true" closable="true"
										style="height: 350px;"
										data-options=" tools:[{ iconCls:'icon-hamburg-refresh', handler:function(){ window.link.reload(); } }] ">
										欢迎您使用本系统
									</div>
								</div>
								<div data-options="region: 'north'" style="width: 48%;">
